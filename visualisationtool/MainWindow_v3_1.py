...
class MainWindow(QtGui.QMainWindow):
    def __init__(self, parent=None):
        ...
        # Add listners to actions
        self.ui.actionSave.triggered.connect(self.saveFile)
        self.ui.actionFilterVisible.triggered.connect(self.filterVisible)
        self.ui.actionUnfilterVisible.triggered.connect(self.unfilterVisible)
    ...
    def run_cluster(self):
        ...
        self.printLog("Clustering using params h={}, alpha={}, mbf={}...".format(self.h,self.alpha,self.mbf))
