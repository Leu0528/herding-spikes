...
# Form implementation generated from reading ui file 'mw_v3_1.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("./icon_toolbar/download-button.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave.setIcon(icon)
        self.actionSave.setObjectName(_fromUtf8("actionSave"))
        self.actionFilterVisible = QtGui.QAction(MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("./icon_toolbar/search.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFilterVisible.setIcon(icon1)
        self.actionFilterVisible.setObjectName(_fromUtf8("actionFilterVisible"))
        self.actionUnfilterVisible = QtGui.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("./icon_toolbar/seo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUnfilterVisible.setIcon(icon2)
        self.actionUnfilterVisible.setObjectName(_fromUtf8("actionUnfilterVisible"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_31.setStatusTip(_translate("MainWindow", "Run clustering using the above params", None))
        self.pushButton_32.setText(_translate("MainWindow", "Segment", None))
        self.pushButton_32.setStatusTip(_translate("MainWindow", "Segment data based on time", None))
        ...
        self.actionSave.setStatusTip(_translate("MainWindow", "Save clustering result as a hdf5 file", None))
        self.actionSave.setShortcut(_translate("MainWindow", "Meta+S", None))
        self.actionFilterVisible.setText(_translate("MainWindow", "filterVisible", None))
        self.actionFilterVisible.setStatusTip(_translate("MainWindow", "Filter visible clusters", None))
        self.actionUnfilterVisible.setText(_translate("MainWindow", "unfilterVisible", None))
        self.actionUnfilterVisible.setStatusTip(_translate("MainWindow", "Unfilter visible clusters", None))
